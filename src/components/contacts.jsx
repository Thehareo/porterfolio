...
function Contacts({animateOut, animateIn}) {
    return (<div id="contacts"><div id="insta" className={`${animateOut ? "animate-out" : ""} ${
      ...
      }`}><a href="https://www.instagram.com/the_hareo/"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="instagram">
      ...
      </svg></a>  <p>Insta</p></div><div id="gmail" className={`${animateOut ? "animate-out" : ""} ${
        animateIn ? "animate-in" : ""
...
<p>harisbinarif@gmail.com</p></div><div id="linkedin" className={`${animateOut ? "animate-out" : ""} ${
        animateIn ? "animate-in" : ""
      }`}><a href="https://www.linkedin.com/in/haris-arif-9b2004331/"><svg xmlns="http://www.w3.org/2000/svg"  width="100" height="100" id="linkedin">
